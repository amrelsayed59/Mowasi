...
<!--  Sell With Us Contact Information : Start -->
<section class="s_w_u_all_pages s_w_u_contact_info s_w_u_bank_info padding40">
    <div class="container">
        <div class="row"><!-- row ( 1 ) -->
            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="input-text" class="control-label"> Account Holder </label>
                                            <input type="text" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="input-text" class="control-label"> Bank Name </label>
                                            <input type="text" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="input-text" class="control-label"> Account Number </label>
                                            <input type="number" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="input-text" class="control-label"> IBAN </label>
                                            <input type="text" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                </div>
...
<!--  Sell With Us Contact Information : End -->
