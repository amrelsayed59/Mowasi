        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="seller_page_left_side a_info_block">
                    <ul>
                        <li> <a href="selling_page.php" class="active"> Selling </a> </li>
                        <li> <a href="sold_page.php"> Sold  </a> </li>
                        <li> <a href="selling_page_your_performance.php"> Your Performance  </a> </li>
                        <li> <a href="selling_page_feedback.php"> My Feedback  </a> </li>
                    </ul>
                </div>
            </div> <!-- // col   -->
            <div class="col-md-9 col-sm-6 col-xs-12">
                <div class="seller_page_right_side">
                    <div class="product-item wishlist_product_item seller_page_item"> <!-- Product Block 1 -->
    <!--                <div class="label l-new"> <p> New </p> </div>-->
                        ...
                        <div class="product-item-info"> <!-- Product Info  -->
                            <div class="product-item-info-title">
                                <a href="product_details_fixed.php"> Sony 65 Inch 4K Ultra HD HDR OLED Android TV - KD-65A1 </a>
                            </div>
                            <div class="item-key_features">
                                <ul>
                                    ...
                                    <li> 
                                        <p> Last updated on Nov 26 </p>
                                    </li>
                                    <li> 
                                        <p><b> Your Currently bid: </b> <span> 295.00 SAR </span> </p>
                                    </li>
                                    <li> 
                                        <p class="time_left"><span class="auction_item_style"> Auction </span> Time left: 6h 34m 7s </p>
                                    </li>
                                    <li> 
                                        <p class="modal_link" data-toggle="modal" data-target="#biddersModal"> Bidders: 34 </p>
                                    </li>
                                </ul>
                            </div>
                        </div> <!-- // Product Info  -->
                        <div class="product-item-price s_seller_info"> <!-- Product Price & Button Details  -->
                            <div class="main-btn">
                                <a href="product_details_auction.php" class="w_buy_now"> View Details </a>
                                <button type="button" class="btn s_delete" data-toggle="modal" data-target="#delete_item"> Delete </button>
                            </div>
                        </div> <!--//  Product Price & Button Details  -->     
                    </div><!-- // Product Block 1 -->
                    
                    <div class="product-item wishlist_product_item"> <!-- Product Block 2 -->
    <!--                <div class="label l-new"> <p> New </p> </div>-->
                        <div class="product-item-img"> <!-- product-img  -->
                        ...
                        <div class="product-item-price s_seller_info"> <!-- Product Price & Button Details  -->
                            <div class="main-btn">
                                <a href="product_details_fixed.php" class="w_buy_now"> View Details </a>
                                <button type="button" class="btn s_delete" data-toggle="modal" data-target="#delete_item"> Delete </button>
                            </div>
                        </div> <!--//  Product Price & Button Details  -->
                    </div><!-- // Product Block 2 -->
                    
                    <div class="product-item wishlist_product_item seller_page_item"> <!-- Product Block 3 -->
    <!--                <div class="label l-new"> <p> New </p> </div>-->
                        <div class="product-item-img"> <!-- product-img  -->
                    ...
                    <div class="product-item wishlist_product_item"> <!-- Product Block 1 -->
    <!--                <div class="label l-new"> <p> New </p> </div>-->
                        <div class="product-item-img"> <!-- product-img  -->
                            <img src="img/img-002.png" class="img-responsive" alt=""/>
                        </div> <!-- // Product-img  -->
